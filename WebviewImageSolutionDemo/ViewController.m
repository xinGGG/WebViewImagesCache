...
- (void)viewDidLoad {
    ...
    [self.webview loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://baidu.com"] cachePolicy:NSURLRequestUseProtocolCachePolicy timeoutInterval:60]];
}
